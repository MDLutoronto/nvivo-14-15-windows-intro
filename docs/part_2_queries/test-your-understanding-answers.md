...
* [Back to the next section](/part_2_queries/coding-queries).

Test Your Understanding 2:

* There are 15 references total. Robert’s interview has 6, Susan’s has 4, and Thomas’ has 5\.
* [Back to the next section](/part_2_queries/matrix-coding-and-crosstab-queries).
...
* [Back to the next section](/part_2_queries/export-data).
